        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="2" style="padding:8px; vertical-align:top;">
                    ...
                    <div style="border-bottom:1px solid #000; height:18px; text-align: center; font-weight: bold;"><?php echo e($requested_by ?? ''); ?></div>
                    <div style="border-bottom:1px solid #000; height:18px; text-align: center;"><?php echo e($designation ?? ''); ?></div>
                </td>
                ...
                <td colspan="2" style="padding:8px; vertical-align:top;">
                    ...
                    <div style="border-bottom:1px solid #000; height:18px;"></div>
                    <div style="border-bottom:1px solid #000; height:18px; text-align: center; font-weight: bold;"><?php echo e($approved_by ?? ''); ?></div>
                    <div style="border-bottom:1px solid #000; height:18px; text-align: center;"><?php echo e($approved_position ?? ''); ?></div>
                </td>
            </tr>
        </tbody>
    </table>
