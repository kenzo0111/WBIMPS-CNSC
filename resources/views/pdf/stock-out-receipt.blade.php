...
<body>
    ...
    <table class="content-table">
        <tr>
            <th>Issue ID</th>
            <td>{{ $stockOut->issue_id }}</td>
        </tr>
        <tr>
            <th>Transaction ID</th>
            <td>{{ $stockOut->transaction_id }}</td>
        </tr>
        <tr>
            <th>Date Issued</th>
            <td>{{ $stockOut->date_issued ? $stockOut->date_issued->format('F d, Y') : '' }}</td>
        </tr>
        <tr>
            <th>Item Name</th>
        ...
        <tr>
            <th>Unit Cost</th>
            <td><span style="font-family: DejaVu Sans;">&#8369;</span> {{ number_format($stockOut->unit_cost, 2) }}</td>
        </tr>
        <tr>
            <th>Total Cost</th>
            <td><span style="font-family: DejaVu Sans;">&#8369;</span> {{ number_format($stockOut->total_cost, 2) }}</td>
        </tr>
        <tr>
            <th>Department</th>
    ...
    <table class="signature-section">
        <tr>
            <td class="signature-cell">
                ...
                <div class="signature-line">{{ $stockOut->issued_by }}</div>
                <div class="signature-label">Signature over Printed Name</div>
            </td>
            <td class="signature-cell">
                <div><strong>Received By:</strong></div>
                <div class="signature-line">{{ $stockOut->issued_to }}</div>
                <div class="signature-label">Signature over Printed Name</div>
            </td>
        </tr>
    </table>
