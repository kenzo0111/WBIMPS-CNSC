...
<body>
    ...
    <table class="meta-row" style="margin-bottom:8px;">
        <tr>
            <td class="meta-left">
                <div><strong>Entity Name :</strong> {{ $entityName ?? '____________________________________' }}</div>
                <div class="meta-sub"><strong>Fund Cluster :</strong> {{ $fundCluster ?? '____________________________________' }}</div>
            </td>
            <td class="meta-right"><strong>ICS No. :</strong> {{ $parNo ?? '_______________' }}</td>
        </tr>
    </table>
