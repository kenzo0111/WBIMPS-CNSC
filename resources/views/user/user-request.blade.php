    ...
    <main class="access-main">
        <div class="access-container">
            <div class="access-content">
                <div class="badge-small">Purchase Request</div>
                <form class="request-card" id="purchaseRequestForm">
                    ...
                    <div class="request-header">
                        <h2>Purchase Request of Office and Sanitorial Supplies</h2>
                    ...
                    <div class="wizard-step" id="step2">
                        <div class="form-grid">
                            ...
                            <div class="form-group" id="approvedByOtherContainer" style="display:none;">
                                <label class="form-label" for="approvedByOther">Specify Other Approver</label>
                                <input class="form-input" id="approvedByOther" name="approvedByOther" type="text" placeholder="Enter approver name" />
                            </div>
                            <div class="form-group">
