...
class StockOutController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'issued_to_designation' => 'nullable|string',
    ...
    public function batchStore(Request $request)
    {
        $validated = $request->validate([
            ...
            'items.*.issued_to_designation' => 'nullable|string',
            'items.*.issued_by' => 'nullable|string',
            'items.*.issued_by_designation' => 'nullable|string',
            'items.*.approved_by' => 'nullable|string',
            'items.*.approved_by_designation' => 'nullable|string',
